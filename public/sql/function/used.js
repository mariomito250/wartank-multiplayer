...
if(checkvp.loai2 == "open") {
     ...
     var idvaaaa = rand(100000,99999999999);
		 ...
		 ruongtrangbi(idvaaaa).chiso.nangcap =+checkvp.cong;
		 ruongtrangbi(idvaaaa).chiso.hp = +ruongtrangbi(idvaaaa).chiso.hp + +ruongtrangbi(idvaaaa).chiso.hp/100*+ruongtrangbi(idvaaaa).tile;
		 ruongtrangbi(idvaaaa).chiso.phep = +ruongtrangbi(idvaaaa).chiso.phep + +ruongtrangbi(idvaaaa).chiso.phep/100*+ruongtrangbi(idvaaaa).tile;
		 ruongtrangbi(idvaaaa).chiso.vatli = +ruongtrangbi(idvaaaa).chiso.vatli + +ruongtrangbi(idvaaaa).chiso.vatli/100*+ruongtrangbi(idvaaaa).tile;
		 ruongtrangbi(idvaaaa).chiso.chimang = +ruongtrangbi(idvaaaa).chiso.chimang + +ruongtrangbi(idvaaaa).chiso.chimang/100*+ruongtrangbi(idvaaaa).tile;
		 ruongtrangbi(idvaaaa).chiso.xuyengiap = +ruongtrangbi(idvaaaa).chiso.xuyengiap + +ruongtrangbi(idvaaaa).chiso.xuyengiap/100*+ruongtrangbi(idvaaaa).tile;
		 ruongtrangbi(idvaaaa).chiso.mp = +ruongtrangbi(idvaaaa).chiso.mp + +ruongtrangbi(idvaaaa).chiso.mp/100*+ruongtrangbi(idvaaaa).tile;
		 ruongtrangbi(idvaaaa).chiso.giap = +ruongtrangbi(idvaaaa).chiso.giap + +ruongtrangbi(idvaaaa).chiso.giap/100*+ruongtrangbi(idvaaaa).tile;
		 ruongtrangbi(idvaaaa).chiso.tocdo = +ruongtrangbi(idvaaaa).chiso.tocdo + +ruongtrangbi(idvaaaa).chiso.tocdo/100*+ruongtrangbi(idvaaaa).tile; 
