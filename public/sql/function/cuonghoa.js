...
var xu_can = Array(
    ...
    function game_cuonghoa(id) {
     ...
     if(ruongtrangbi(id).chiso.nangcap >=15) {
        giaotiep(t('Đã đạt cấp tối đa.'));
        return false;
    }
    
    if(soluong(11) < da_can[+ruongtrangbi(id).chiso.nangcap]) {
        giaotiep(t('Bạn chưa đủ đá để nâng cấp.'));
        return false;
    }
    if(my.users.xu < xu_can[+ruongtrangbi(id).chiso.nangcap]) {
    ...
    c_giaotiep();
    ch();
    xu(-xu_can[+ruongtrangbi(id).chiso.nangcap]);
   vatpham(11,-da_can[+ruongtrangbi(id).chiso.nangcap]);
    if(rand(1,100) <= tile_can[+ruongtrangbi(id).chiso.nangcap]) {
        setTimeout(function(){
            ruongtrangbi(id).chiso.nangcap = +ruongtrangbi(id).chiso.nangcap+1;
            giaotiep(' '+t('Nâng cấp thành công ! Trang bị được lên cấp')+' '+ruongtrangbi(id).chiso.nangcap+'  ');
            cuonghoa(1,id);
        }, 300);

    } else {
        if(+ruongtrangbi(id).chiso.nangcap <=2) {
            ruongtrangbi(id).chiso.nangcap=0;
        }
        
        if(+ruongtrangbi(id).chiso.nangcap >=3 && +ruongtrangbi(id).chiso.nangcap <=5) {
            ruongtrangbi(id).chiso.nangcap=3;
        }
        
        if(+ruongtrangbi(id).chiso.nangcap >=6 && +ruongtrangbi(id).chiso.nangcap <=8) {
            ruongtrangbi(id).chiso.nangcap=6;
        }
        if(+ruongtrangbi(id).chiso.nangcap >=9 && +ruongtrangbi(id).chiso.nangcap <=11) {
            ruongtrangbi(id).chiso.nangcap=9;
        }
        if(+ruongtrangbi(id).chiso.nangcap >=12 && +ruongtrangbi(id).chiso.nangcap <=14) {
            ruongtrangbi(id).chiso.nangcap=12;
        }
        if(+ruongtrangbi(id).chiso.nangcap >=14 ) {
            ruongtrangbi(id).chiso.nangcap=14;
        }
        
   setTimeout(function(){
            ruongtrangbi(id).chiso.nangcap = +ruongtrangbi(id).chiso.nangcap;
            giaotiep(''+t('Xin lỗi, ta đã làm hết sức ! Trang bị tụt xuống cấp')+' '+ruongtrangbi(id).chiso.nangcap+'  ');
            cuonghoa(1,id);
        }, 300);     
  ...
  function game_cuonghoacanthan(id) {
    ...
    if(my.users.ruby < ruby_can[+ruongtrangbi(id).chiso.nangcap]) {
    ...
    c_giaotiep();
    ch();
    ruby(-ruby_can[+ruongtrangbi(id).chiso.nangcap]);
   vatpham(11,-da_can[+ruongtrangbi(id).chiso.nangcap]);
    if(rand(1,100) <= tile_can[+ruongtrangbi(id).chiso.nangcap]) {
        setTimeout(function(){
            ruongtrangbi(id).chiso.nangcap = +ruongtrangbi(id).chiso.nangcap+1;
...
if(+ruongtrangbi(idtb).chiso.mp >=1) 
 ...
 if(+ruongtrangbi(idtb).chiso.tocdo >=1) 
      ...
      ac+='<div class="menu list">'+ruongtrangbi(idtb).chiso.ten+' + '+ruongtrangbi(idtb).chiso.nangcap+' <br> '+ty+' </div>';
    
      ac+='<center><div class="canvas_menu" onclick="game_cuonghoacanthan('+idtb+')">'+t('Cận thận')+'</div> <br> '+t('Tỉ lệ thành công')+' : '+tile_can[+ruongtrangbi(idtb).chiso.nangcap]+'% <br> '+t('Ruby cần')+' : '+tron(ruby_can[+ruongtrangbi(idtb).chiso.nangcap])+' <br> '+t('Đá cần')+' : '+da_can[+ruongtrangbi(idtb).chiso.nangcap]+'   </center>';
...
if(+ruongtrangbi(idtb).chiso.mp >=1) 
 ...
 if(+ruongtrangbi(idtb).chiso.tocdo >=1) 
      ...
      ac+='<center><div class="canvas_menu" onclick="game_cuonghoa('+idtb+')">'+t('cường hóa')+'</div> <br> '+t('Tỉ lệ thành công')+' : '+tile_can[+ruongtrangbi(idtb).chiso.nangcap]+'% <br> '+t('Xu cần')+' : '+tron(xu_can[+ruongtrangbi(idtb).chiso.nangcap])+' <br> '+t('Đá cần')+' : '+da_can[+ruongtrangbi(idtb).chiso.nangcap]+'   </center>';
