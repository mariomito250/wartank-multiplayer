...
url : 'admin.ducnghia',
type : 'POST',
data : {index :1 , a:'index',b:'admin'},

ducnghia : function(result){
  $('#cpanelxxx').html(result);
}
});
}  
...
function save(){
    $.nghia({
            	       	url         : 'admin.ducnghia',
    	            	type        : 'POST',
    	            	data        : $("#crducnghia").find("select, textarea, input").serialize(),
                  	ducnghia : function(result){
...
url : 'admin.ducnghia',
type : 'POST',
data : {index :code , a:'menu',b:'admin'},
...
function thongbao(ducnghiant) {
$.notify(ducnghiant, "success");
}
