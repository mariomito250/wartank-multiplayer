...
<div class="container" style="width: 99%;">
    ...
    <div id="mws-explore-area" style="height:457px;">
        ...
        <!-----box canvas-------->
        <div id="box" style="display:none;position: absolute;background: #977b54;left:0%;width:65%;height: 100%;z-index:10;top:0px;">
            <div id="head"></div>
            <div style="position:absolute;top:0px;right:0%;"><img onclick="c_box()" src="/sql/load/myTexture2dbtX_346.png"
                width="25">
            </div>


            <div style="bottom:4%; background: #d9c8b4;width:100%;height: 85%;position:absolute;">
    ...
    margin-top: -13px;"><img src="/sql/load/xu.png">
        ...
        <!--------------->
        <div id="canvas" style="display:none;position: absolute;background: url(/sql/load/img/canvas/duc.png) no-repeat;height: 413px;background-position: center top;background-size: 100% 100%;z-index:10;">
